...
+=========================================================================================+=================================================================+======================================+
| COMM: Communication expenses such as phone bills, postage, etc.                         | FOOD: Meal expenses such as restaurants, business lunches, etc. | EXP_GEN: Others                      |
+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------+--------------------------------------+
| TRANS & ACCT: Travel and accommodation expenses such as hotel, plane ticket, taxi, etc. | MIL: Mileage.                                                   | GIFT: Gifts to customers or vendors. |
+-----------------------------------------------------------------------------------------+-----------------------------------------------------------------+--------------------------------------+
...
.. example::
   ...
   :guilabel:`Expenses` and :guilabel:`Sales Orders` smart buttons display the number of linked
   records on the top of the expense report.
...
Click the :guilabel:`Sales Orders` smart button, then select the desired :abbr:`SO (Sales Order)`.
Click the :guilabel:`Invoices` smart button.
...
:guilabel:`Payment` and :guilabel:`Payment Transaction` smart buttons display at the top of the
invoice form.

Click :guilabel:`Payments` to go to the :guilabel:`Pay` form. Click :guilabel:`Validate` to confirm
that the invoice payment has been received. The Pay form is automatically updated to
:guilabel:`Paid`.
